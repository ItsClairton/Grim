...
dependencies {
    implementation("com.github.itsclairton.packetevents:packetevents-spigot:3e8283f33d")
...
tasks {
    ...
    runServer {
        ...
        downloadPlugins {
            ...
            url("https://ci.lucko.me/job/spark/lastSuccessfulBuild/artifact/spark-bukkit/build/libs/spark-1.10.119-bukkit.jar")
        }
    }
